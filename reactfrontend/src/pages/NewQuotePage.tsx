...
import { catalogService } from '../services/catalogService'; // Necesario para buscar productos
...
const NewQuotePage: React.FC = () => {
  ...
  // Estado para el buscador de productos (Modo Facturador)
  ...
  // 1. Cargar usuarios si es Admin o Vendedor
  useEffect(() => {
  ...
  // 2. Lógica del buscador de productos (Modo Facturador)
  useEffect(() => {
    const searchProducts = async () => {
      ...
      try {
        setIsSearching(true);
        // Usamos el servicio de búsqueda rápida
  ...
  // Vista de Carrito Vacío para Clientes (Bloqueo)
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* COLUMNA IZQUIERDA: Formulario y Buscador */}
            <div className="lg:col-span-2 space-y-6">
              
              {/* 1. Configuración de la Cotización */}
              ...
              {/* 2. Buscador Rápido (Solo Admin/Vendedor) */}
              {isAdminOrVendor && (
              ...
              {/* 3. Lista de Productos en la Cotización */}
              <div className="bg-white dark:bg-background-dark rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
